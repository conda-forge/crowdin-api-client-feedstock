...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/crowdin-api-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/crowdin-api-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add crowdin-api-client
# for installing globally
pixi global install crowdin-api-client
```
...
It is possible to list all of the versions of `crowdin-api-client` available on your platform:
...
```
pixi search crowdin-api-client --channel conda-forge
```
